...
D3DInstance::D3DInstance(const D3DInstance& other) {}
D3DInstance::~D3DInstance() {}

bool D3DInstance::Initialize(int screenWidth, int screenHeight, bool vsync, HWND hwnd, bool fullscreen, float screenDepth, float screenNear) {
	HRESULT result {};
	...
	// Changed for cubemap hack ("An optimization" https://learnopengl.com/Advanced-OpenGL/Cubemaps)
...
ID3D11Device* D3DInstance::GetDevice() {
	return m_Device;
}

ID3D11DeviceContext* D3DInstance::GetDeviceContext() {
	return m_DeviceContext;
}

void D3DInstance::GetProjectionMatrix(DirectX::XMMATRIX & projectionMatrix) {
	projectionMatrix = m_ProjectionMatrix;
}

void D3DInstance::GetWorldMatrix(DirectX::XMMATRIX& worldMatrix) {
	worldMatrix = m_WorldMatrix;
}

void D3DInstance::GetOrthoMatrix(DirectX::XMMATRIX& orthoMatrix) {
	orthoMatrix = m_OrthoMatrix;
}

void D3DInstance::GetVideoCardInfo(char* cardName, int& memory) {
